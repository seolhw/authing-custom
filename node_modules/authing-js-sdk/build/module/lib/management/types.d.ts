 ...
 * 用户支持的操作日志类型枚举
 */
export declare enum SupportedUserActionEnum {
    /**
     * 登录
     */
    LOGIN = "login",
 ...
 * 管理员支持的操作日志类型枚举
 */
export declare enum SupportedAdminActionEnum {
    /**
     * 删除用户
     */
...
export type BatchFetchUserTypes = 'id' | 'username' | 'phone' | 'email' | 'externalId';
