    ...
    var AuthenticationClient = /** @class */ (function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 2:
                            ...
                            extraParams = null;
                            if (customData) {
                                extraParams = JSON.stringify((0, utils_1.convertObjectToKeyValueList)(customData));
                            }
                            else if (params) {
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.registerByEmail)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        email: email,
                                        password: password,
                                        profile: profile,
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.registerByUsername)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        username: username,
                                        password: password,
                                        profile: profile,
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.registerByPhoneCode)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        phone: phone,
                                        code: code,
        ...
        AuthenticationClient.prototype.checkPasswordStrength = function (password) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.checkPasswordStrength)(this.graphqlClient, this.tokenProvider, { password: password })];
                        case 1:
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.loginByEmail)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        email: email,
                                        password: password,
                        ...
                        case 3:
                            ...
                            if (user.customData) {
                                // @ts-ignore
                                user.customData = (0, utils_1.convertUdvToKeyValuePair)(user.customData);
                            }
                            this.setCurrentUser(user);
                            return [2 /*return*/, user];
                    }
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.loginByUsername)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        username: username,
                                        password: password,
                                        autoRegister: autoRegister,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.loginByPhoneCode)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        phone: phone,
                                        code: code,
                                        phoneCountryCode: phoneCountryCode,
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            url = "".concat((_a = this.options.appHost) !== null && _a !== void 0 ? _a : "", "/api/v2/login/email-code");
                            return [4 /*yield*/, this.httpClient.request({
                                    method: 'POST',
                                    url: url,
                                    data: {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.loginByPhonePassword)(this.graphqlClient, this.tokenProvider, {
                                    input: {
                                        phone: phone,
                                        password: password,
                                        captchaCode: captchaCode,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 2:
                            password = _d.sent();
                            return [4 /*yield*/, (0, graphqlapi_1.loginBySubAccount)(this.graphqlClient, this.tokenProvider, {
                                    account: account,
                                    password: password,
                                    captchaCode: captchaCode,
                                    clientIp: clientIp
        ...
        AuthenticationClient.prototype.checkLoginStatus = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.checkLoginStatus)(this.graphqlClient, this.tokenProvider, {
                                token: token
                            })];
                        case 1:
                            res = _a.sent();
        ...
        AuthenticationClient.prototype.sendEmail = function (email, scene) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.sendEmail)(this.graphqlClient, this.tokenProvider, { email: email, scene: scene })];
                        case 1:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 2:
                            newPassword = _d.sent();
                            return [4 /*yield*/, (0, graphqlapi_1.resetPassword)(this.graphqlClient, this.tokenProvider, {
                                    phone: phone,
                                    code: code,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 2:
                            password = _d.sent();
                            return [4 /*yield*/, (0, graphqlapi_1.resetPasswordByFirstLoginToken)(this.graphqlClient, this.tokenProvider, {
                                    token: token,
                                    password: password
                                })];
                        case 3:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 4:
                            oldPassword = _g.sent();
                            return [4 /*yield*/, (0, graphqlapi_1.resetPasswordByForceResetToken)(this.graphqlClient, this.tokenProvider, {
                                    token: token,
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.updateUser)(this.graphqlClient, this.tokenProvider, {
                                    id: userId,
                                    input: updates,
                                    emailToken: emailToken,
                                    phoneToken: phoneToken
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_j) {
                    switch (_j.label) {
                        ...
                        case 6:
                            oldPassword = _e;
                            return [4 /*yield*/, (0, graphqlapi_1.updatePassword)(this.graphqlClient, this.tokenProvider, {
                                    newPassword: newPassword,
                                    oldPassword: oldPassword
                                })];
                        case 7:
        ...
        AuthenticationClient.prototype.updatePhone = function (phone, phoneCode, oldPhone, oldPhoneCode, phoneCountryCode, oldPhoneCountryCode) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.updatePhone)(this.graphqlClient, this.tokenProvider, {
                                phone: phone,
                                phoneCode: phoneCode,
                                oldPhone: oldPhone,
        ...
        AuthenticationClient.prototype.updateEmail = function (email, emailCode, oldEmail, oldEmailCode) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.updateEmail)(this.graphqlClient, this.tokenProvider, {
                                email: email,
                                emailCode: emailCode,
                                oldEmail: oldEmail,
        ...
        AuthenticationClient.prototype.refreshToken = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.refreshToken)(this.graphqlClient, this.tokenProvider, {})];
                        case 1:
        ...
        AuthenticationClient.prototype.bindPhone = function (phone, phoneCode, phoneCountryCode) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.bindPhone)(this.graphqlClient, this.tokenProvider, {
                                phone: phone,
                                phoneCode: phoneCode,
                                phoneCountryCode: phoneCountryCode
                            })];
        ...
        AuthenticationClient.prototype.unbindPhone = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.unbindPhone)(this.graphqlClient, this.tokenProvider, {})];
                        case 1:
        ...
        AuthenticationClient.prototype.bindEmail = function (email, emailCode) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.bindEmail)(this.graphqlClient, this.tokenProvider, {
                                email: email,
                                emailCode: emailCode
                            })];
                        case 1:
        ...
        AuthenticationClient.prototype.unbindEmail = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.unbindEmail)(this.graphqlClient, this.tokenProvider, {})];
                        case 1:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, (0, graphqlapi_1.user)(this.graphqlClient, this.tokenProvider, {})];
                        case 1:
                            data = (_b.sent()).user;
                            if (data.customData) {
                                // @ts-ignore
                                data.customData = (0, utils_1.convertUdvToKeyValuePair)(data.customData);
                            }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            userId = this.checkLoggedIn();
                            return [4 /*yield*/, (0, graphqlapi_1.udv)(this.graphqlClient, this.tokenProvider, {
                                    targetType: graphql_v2_1.UdfTargetType.User,
                                    targetId: userId
                                })];
                        case 1:
                            list = (_a.sent()).udv;
                            return [2 /*return*/, (0, utils_1.convertUdv)(list)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.setUdv)(this.graphqlClient, this.tokenProvider, {
                                    targetType: graphql_v2_1.UdfTargetType.User,
                                    targetId: userId,
                                    key: key,
                                    value: value
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            userId = this.checkLoggedIn();
                            return [4 /*yield*/, (0, graphqlapi_1.removeUdv)(this.graphqlClient, this.tokenProvider, {
                                    targetType: graphql_v2_1.UdfTargetType.User,
                                    targetId: userId,
                                    key: key
                                })];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            userId = this.checkLoggedIn();
                            return [4 /*yield*/, (0, graphqlapi_1.getUserDepartments)(this.graphqlClient, this.tokenProvider, {
                                    id: userId
                                })];
                        case 1:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            list = (_a.sent()).udv;
                            return [2 /*return*/, (0, utils_1.convertUdvToKeyValuePair)(list)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            userId = this.checkLoggedIn();
                            return [4 /*yield*/, (0, graphqlapi_1.setUdvBatch)(this.graphqlClient, this.tokenProvider, {
                                    targetType: graphql_v2_1.UdfTargetType.User,
                                    targetId: userId,
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.listUserAuthorizedResources)(this.graphqlClient, this.tokenProvider, {
                                    id: userId,
                                    namespace: namespace,
                        ...
                        case 1:
                            ...
                            list = (0, utils_1.formatAuthorizedResources)(list);
                            return [2 /*return*/, {
                                    list: list,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.isUserExists)(this.graphqlClient, this.tokenProvider, {
                                    username: username,
                                    email: email,
                                    phone: phone,
        ...
        AuthenticationClient.prototype.generateCodeChallenge = function () {
            return (0, utils_1.generateRandomString)(43);
        };
        AuthenticationClient.prototype.getCodeChallengeDigest = function (options) {
            ...
            if (method === 'S256') {
                // url safe base64
                return (0, sha256_1.default)(options.codeChallenge)
        ...
        AuthenticationClient.prototype.hasRole = function (roleCode, namespace) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.getUserRoles)(this.graphqlClient, this.tokenProvider, {
...
//# sourceMappingURL=AuthenticationClient.js.map