...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../types/graphql.v2", "./jsencrypt/jsencrypt", "./sm-crypto/sm2/index"], factory);
    }
    ...
    var jsencrypt_1 = require("./jsencrypt/jsencrypt");
    var index_1 = require("./sm-crypto/sm2/index");
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    if (encryption && (encryption === null || encryption === void 0 ? void 0 : encryption.type) === 'sm2') {
                        ...
                        var encrypted_1 = (0, index_1.doEncrypt)(plainText, encryption.publicKey);
    ...
    var isMobileBrowser = function () {
        return (0, exports.isWechatBrowser)() || (0, exports.isLarkBrowser)();
    };
            ...
            xhr.onreadystatechange = function () {
                ...
                if (this.readyState === 4) {
                    try {
                        ...
                        var code = 500;
                        var message = "\u4E0A\u4F20\u56FE\u7247\u5931\u8D25, error = ".concat(error.message);
                        reject({
                            code: code,
                            message: message
                        });
            ...
            inputElem.onchange = function () {
                ...
                if (!multiple) {
                    ...
                    while (i < files.length) {
                        promises.push((0, exports.xhrUpload)(files[i], url));
                        i++;
                    }
