...
var UsersManagementClient = /** @class */ (function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        _d.password = _h.sent();
                        _h.label = 3;
                    case 3: return [4 /*yield*/, (0, graphqlapi_1.createUser)(this.graphqlClient, this.tokenProvider, {
                            userInfo: userInfo,
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        _a.password = _e.sent();
                        _e.label = 3;
                    case 3: return [4 /*yield*/, (0, graphqlapi_1.updateUser)(this.graphqlClient, this.tokenProvider, {
                            id: id,
                            input: updates
                        })];
                    case 4:
    ...
    UsersManagementClient.prototype.delete = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.deleteUser)(this.graphqlClient, this.tokenProvider, {
                            id: userId
                        })];
                    case 1:
    ...
    UsersManagementClient.prototype.deleteMany = function (userIds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.deleteUsers)(this.graphqlClient, this.tokenProvider, {
                            ids: userIds
                        })];
                    case 1:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, graphqlapi_1.usersWithCustomData)(this.graphqlClient, this.tokenProvider, {
                                page: page,
                                limit: limit,
                    ...
                    case 2: return [4 /*yield*/, (0, graphqlapi_1.users)(this.graphqlClient, this.tokenProvider, {
                            page: page,
                            limit: limit,
                            excludeUsersInOrg: excludeUsersInOrg
                        })];
    ...
    UsersManagementClient.prototype.listArchivedUsers = function (page, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.archivedUsers)(this.graphqlClient, this.tokenProvider, {
                            page: page,
                            limit: limit
                        })];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!withCustomData) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, graphqlapi_1.findUserWithCustomData)(this.graphqlClient, this.tokenProvider, {
                                username: username,
                                email: email,
                                phone: phone,
                                externalId: externalId
                    ...
                    case 1:
                        ...
                        user.customData = (0, utils_1.convertUdvToKeyValuePair)(user.customData);
                        return [2 /*return*/, user];
                    case 2: return [4 /*yield*/, (0, graphqlapi_1.findUser)(this.graphqlClient, this.tokenProvider, {
                            username: username,
                            email: email,
                            phone: phone,
                            externalId: externalId,
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!!withCustomData) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, graphqlapi_1.searchUser)(this.graphqlClient, this.tokenProvider, {
                                query: query,
                                fields: fields,
                                page: page,
                                limit: limit,
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data];
                    case 2: return [4 /*yield*/, (0, graphqlapi_1.searchUserWithCustomData)(this.graphqlClient, this.tokenProvider, {
                            query: query,
                            fields: fields,
                            page: page,
                            limit: limit,
    ...
    UsersManagementClient.prototype.listGroups = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.getUserGroups)(this.graphqlClient, this.tokenProvider, {
                            id: userId
                        })];
                    case 1:
                        user = (_a.sent()).user;
    ...
    UsersManagementClient.prototype.addGroup = function (userId, group) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.addUserToGroup)(this.graphqlClient, this.tokenProvider, {
                            userIds: [userId],
                            code: group
                        })];
                    case 1:
    ...
    UsersManagementClient.prototype.removeGroup = function (userId, group) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.removeUserFromGroup)(this.graphqlClient, this.tokenProvider, {
                            code: group,
                            userIds: [userId]
                        })];
                    case 1:
    ...
    UsersManagementClient.prototype.addRoles = function (userId, roles, namespace) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.assignRole)(this.graphqlClient, this.tokenProvider, {
                            roleCodes: roles,
                            userIds: [userId],
                            namespace: namespace
                        })];
    ...
    UsersManagementClient.prototype.removeRoles = function (userId, roles, namespace) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.revokeRole)(this.graphqlClient, this.tokenProvider, {
                            roleCodes: roles,
                            userIds: [userId],
                            namespace: namespace
                        })];
    ...
    UsersManagementClient.prototype.listDepartment = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.getUserDepartments)(this.graphqlClient, this.tokenProvider, {
                            id: userId
                        })];
                    case 1:
    ...
    UsersManagementClient.prototype.getUdfValue = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.udv)(this.graphqlClient, this.tokenProvider, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, graphqlapi_1.udfValueBatch)(this.graphqlClient, this.tokenProvider, {
                                targetType: graphql_v2_1.UdfTargetType.User,
                                targetIds: userIds
                            })];
                    case 1:
                        ...
                        for (_i = 0, result_1 = result; _i < result_1.length; _i++) {
                            ...
                            ret[targetId] = (0, utils_1.convertUdvToKeyValuePair)(data);
                        }
                        return [2 /*return*/, ret];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, graphqlapi_1.setUdfValueBatch)(this.graphqlClient, this.tokenProvider, {
                                targetType: graphql_v2_1.UdfTargetType.User,
                                input: params
                            })];
                    case 1:
    ...
    UsersManagementClient.prototype.removeUdfValue = function (userId, key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.removeUdv)(this.graphqlClient, this.tokenProvider, {
                            targetType: graphql_v2_1.UdfTargetType.User,
                            targetId: userId,
                            key: key
                        })];
    ...
    UsersManagementClient.prototype.sendFirstLoginVerifyEmail = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, graphqlapi_1.sendFirstLoginVerifyEmail)(this.graphqlClient, this.tokenProvider, options)];
                    case 1:
                        _a.sent();
