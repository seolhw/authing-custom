            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        headers[this.options.headers['sdk-version']] = "js:".concat(version_1.SDK_VERSION);
                        headers[this.options.headers.lang] = this.options.lang || '';
                        if (!!config.unSetToken) return [3 /*break*/, 3];
                        if (!!(config && config.headers && config.headers.authorization)) return [3 /*break*/, 2];
                        return [4 /*yield*/, ((_a = this.tokenProvider) === null || _a === void 0 ? void 0 : _a.getToken())];
                    case 1:
                        token = _b.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.axios.request(__assign(__assign({}, config), { headers: __assign({}, (0, utils_1.pickBy)(config.headers, function (i) { return !!i; })) }))];
                    case 4:
                        data = (_b.sent()).data;
